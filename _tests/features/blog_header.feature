Feature: Test blog page header
  ...
  Scenario Outline: Header's logo link should be loaded
    ...
    And I should see that header's logo link has text "Yi Zeng’s Blog"
  ...
  Scenario Outline: Header's navigation links should be working as intended
    ...
    Examples:
      ...
      | Yi Zeng’s Blog | /blog/            | All Posts \| Yi Zeng’s Blog  | All Posts            |
      | Categories     | /blog/categories/ | Categories \| Yi Zeng’s Blog | Posts By Category    |
      | Tags           | /blog/tags/       | Tags \| Yi Zeng’s Blog       | Posts By Tag         |
